...
const ALIAS = {
  ...
  'how-to-get-echo-shard':'echo-shard-icon','how-to-get-trial-key':'trial-key-icon','how-to-get-heavy-core':'heavy-core-icon','how-to-get-slimeballs':'slimeball-icon','how-to-get-dried-ghast':'dried-ghast-icon','how-to-get-wind-charges':'wind-charge-icon','how-to-get-cinnabar':'cinnabar-icon','how-to-get-poplar-logs':'poplar-log-icon','how-to-get-bone-meal':'bone-meal-icon','how-to-get-sulfur':'sulfur-icon','how-to-get-ice':'ice-icon','how-to-get-swift-sneak':'swift-sneak-icon','how-to-get-eye-of-ender':'eye-of-ender-icon','how-to-get-sculk':'sculk-icon','how-to-get-camel-husk':'camel-husk-icon','how-to-get-sniffer-egg':'sniffer-egg-icon','how-to-get-ominous-bottle':'ominous-bottle-icon','how-to-get-wind-burst':'wind-burst-icon','how-to-get-ominous-trial-key':'ominous-trial-key-icon','how-to-get-smithing-templates':'smithing-template-icon','how-to-get-froglight':'froglight-icon',
